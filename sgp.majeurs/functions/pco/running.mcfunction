...
execute as @a[scores={liberer_oies=2}] run function sgp.majeurs:pco/oie/liberer
execute as @a[scores={liberer_oies=2}] run scoreboard players set @a liberer_oies 0
execute as @a[scores={liberer_poules=2}] run function sgp.majeurs:pco/poule/liberer
execute as @a[scores={liberer_poules=2}] run scoreboard players set @a liberer_poules 0
execute as @a[scores={liberer_canards=2}] run function sgp.majeurs:pco/canard/liberer
...
execute as @a[team=Poule] run scoreboard players add #poules_joueurs dummy 1
execute as @a[team=Poule,scores={en_cage=1}] run scoreboard players add #poules en_cage 1
execute if score #poules en_cage = #poules_joueurs dummy run function sgp.majeurs:pco/_stop
execute if score #poules en_cage = #poules_joueurs dummy run title @a[x=2405,y=201,z=2133,dx=137,dy=54,dz=72] title {"text":"Oies Victorieuses","color":"yellow","bold":true}
scoreboard players set #poules_joueurs dummy 0
...
execute as @a[team=Canard] run scoreboard players add #canards_joueurs dummy 1
execute as @a[team=Canard,scores={en_cage=1}] run scoreboard players add #canards en_cage 1
execute if score #canards en_cage = #canards_joueurs dummy run function sgp.majeurs:pco/_stop
execute if score #canards en_cage = #canards_joueurs dummy run title @a[x=2405,y=201,z=2133,dx=137,dy=54,dz=72] title {"text":"Poules Victorieuses","color":"red","bold":true}
scoreboard players set #canards_joueurs dummy 0
...
execute as @a[team=Oie] run scoreboard players add #oies_joueurs dummy 1
execute as @a[team=Oie,scores={en_cage=1}] run scoreboard players add #oies en_cage 1
execute if score #oies en_cage = #oies_joueurs dummy run function sgp.majeurs:pco/_stop
execute if score #oies en_cage = #oies_joueurs dummy run title @a[x=2405,y=201,z=2133,dx=137,dy=54,dz=72] title {"text":"Canards Victorieux","color":"green","bold":true}
scoreboard players set #oies_joueurs dummy 0
