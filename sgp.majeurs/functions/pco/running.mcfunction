...
execute as @a[scores={sgp.liberer_oies=2}] run scoreboard players set @a sgp.liberer_oies 0
execute as @a[scores={sgp.liberer_poules=2}] run function sgp.majeurs:pco/poule/liberer
execute as @a[scores={sgp.liberer_poules=2}] run scoreboard players set @a sgp.liberer_poules 0
execute as @a[scores={sgp.liberer_canards=2}] run function sgp.majeurs:pco/canard/liberer
execute as @a[scores={sgp.liberer_canards=2}] run scoreboard players set @a sgp.liberer_canards 0
...
execute if score #poules sgp.en_cage = #poules_joueurs sgp.dummy run title @a[x=2405,y=201,z=2133,dx=137,dy=54,dz=72] title {"text":"Oies Victorieuses","color":"yellow","bold":true}
...
execute if score #canards sgp.en_cage = #canards_joueurs sgp.dummy run title @a[x=2405,y=201,z=2133,dx=137,dy=54,dz=72] title {"text":"Poules Victorieuses","color":"red","bold":true}
...
execute if score #oies sgp.en_cage = #oies_joueurs sgp.dummy run title @a[x=2405,y=201,z=2133,dx=137,dy=54,dz=72] title {"text":"Canards Victorieux","color":"green","bold":true}
