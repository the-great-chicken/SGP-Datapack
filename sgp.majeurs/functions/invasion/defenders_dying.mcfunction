...
execute at @e[type=marker,name="kits",limit=1] as @a[distance=..3,team=sgp.Defenseur] run team leave @s
execute at @e[type=marker,name="kits",limit=1] as @a[distance=..3,team=sgp.Defenseur] run move @s #Morts
execute at @e[type=marker,name="kits",limit=1] as @a[distance=..3,team=sgp.Defenseur] run gamemode spectator @s
execute at @e[type=marker,name="kits",limit=1] as @a[distance=..3,team=sgp.Defenseur] run tp @s 2531 251.5 2198 135 0
