...
tag @p[scores={sgp.devenir_roi_rouge=1..}] add roi_rouge
execute at @e[tag=sgp.marker,name="sgp.devenir_roi_rouge",limit=1] as @a[distance=..2] run team join sgp.rouge @s
...
tp @p[scores={sgp.devenir_roi_rouge=1..}] 2429.5 229 2172.0 270 0
execute at @e[tag=sgp.marker,name="sgp.devenir_roi_rouge",limit=1] as @a[distance=..2] run scoreboard players set @s sgp.entre_kits 1
scoreboard players set @p[scores={sgp.devenir_roi_rouge=1..}] sgp.devenir_roi_rouge 0
execute as @a[x=2405,y=201,z=2133,dx=137,dy=54,dz=72] run trigger sgp.devenir_roi_rouge set 0
