...
$execute as @s unless score @s $(effect)_kill_unlocked matches 1 run tellraw @s [{"text":"Tu n'as pas encore débloqué le Kill Effect ","bold":false,"color":"red"},{"text":"$(effet)","bold":true,"color":"$(couleur)"},{"text":" !\n","bold":false,"color":"red"},{"text":"Tu trouveras peut-être une façon de le débloquer durant la soirée !","color":"aqua"}]