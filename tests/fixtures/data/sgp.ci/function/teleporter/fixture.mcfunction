...
data modify storage sgp.ci:teleporter state.sources set value []
...
execute as @n[tag=sgp.ci.portal_a,type=marker] run function sgp.misc:uuid_array_to_string/init {list_location:"sgp.ci:teleporter state.sources"}
...
execute as @n[tag=sgp.ci.portal_b,type=marker] run function sgp.misc:uuid_array_to_string/init {list_location:"sgp.ci:teleporter state.sources"}
