#> sgp.ci:diorama_mapping/scenarios/giant_center_and_ramp
...
function sgp.ci:diorama_mapping/expect {group:giant,x:32,y:80,z:24}
...
execute at @s run function sgp.diorama:tick/update_mannequin/update_giant_pos {id:94001}
function sgp.ci:diorama_mapping/expect {group:giant,x:20,y:72,z:32}
