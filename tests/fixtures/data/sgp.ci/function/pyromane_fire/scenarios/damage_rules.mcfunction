#> sgp.ci:pyromane_fire/scenarios/damage_rules

# Re-establish exact distances after the join-protection wait; no physics tick may intervene.
tp FireOwner ~0.5 ~1 ~0.5
tp FireNear ~2.5 ~1 ~0.5
tp FireEdge ~4 ~1 ~0.5
tp FirePeace ~0.5 ~1 ~2.5
tp FireOutside ~0.5 ~1 ~3.5
execute as @a[tag=sgp.ci.fire_actor] run assert entity @s[nbt={Health:20.0f}]
...
execute positioned ~0.5 ~1 ~0.5 run assert entity @a[name=FireEdge,distance=3.5]
