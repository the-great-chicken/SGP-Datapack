...
gamemode creative @s
tp @s ~0.5 ~1 ~0.5 0 0
summon tnt ~2.5 ~1 ~0.5 {Tags:["sgp.tnt","sgp.new","sgp.ci.tnt_charge_a"],fuse:100s,NoGravity:1b,Motion:[0.0d,0.0d,0.0d]}
...
tag @e[tag=sgp.ci.tnt_charge_a,type=tnt] remove sgp.new
...
summon tnt ~1.5 ~1 ~0.5 {Tags:["sgp.tnt","sgp.new","sgp.ci.tnt_charge_b"],fuse:100s,NoGravity:1b,Motion:[0.0d,0.0d,0.0d]}
...
tag @e[tag=sgp.ci.tnt_charge_b,type=tnt] remove sgp.new
