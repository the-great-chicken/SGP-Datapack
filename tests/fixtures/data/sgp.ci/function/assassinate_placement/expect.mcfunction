...
execute store result score #ci.assassinate.count sgp.dummy if entity @e[tag=sgp.ci.assassinate,distance=..24,type=ender_pearl]
assert score #ci.assassinate.count sgp.dummy matches 1
execute store result score #ci.assassinate.count sgp.dummy if entity @e[tag=sgp.ci.assassinate,distance=..24,type=endermite]
assert score #ci.assassinate.count sgp.dummy matches 1
