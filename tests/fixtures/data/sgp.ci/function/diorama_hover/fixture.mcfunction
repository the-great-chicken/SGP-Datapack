...
summon text_display ~3.5 ~1 ~5.5 {Tags:["sgp.ci.hover","sgp.ci.hover_first","sgp.spawn_tper_text"],text:"First",transformation:{scale:[0.55f,0.55f,0.55f]}}
summon text_display ~8.5 ~1 ~5.5 {Tags:["sgp.ci.hover","sgp.ci.hover_second","sgp.spawn_tper_text"],text:"Second",transformation:{scale:[0.55f,0.55f,0.55f]}}
...
summon text_display ~3.5 ~1 ~5.5 {Tags:["sgp.ci.hover","sgp.ci.hover_unrelated","sgp.spawn_tper_text"],text:"Unrelated",transformation:{scale:[1f,1f,1f]}}
