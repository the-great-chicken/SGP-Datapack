#> sgp.ci:activation_items/whole_item
...
assert entity @e[tag=sgp.ci.activation_marker,distance=..8,type=marker]
assert entity @e[tag=sgp.ci.activation_item,distance=..4,type=item]
