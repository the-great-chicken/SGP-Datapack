...
execute as @e[tag=sgp.ci.lootdrop,name=Lootdrop,type=marker] run function sgp.misc:uuid_array_to_string/init {list_location:"sgp:data markers_lists.lootdrop"}
