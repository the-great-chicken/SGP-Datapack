...
$data modify entity @e[tag=sgp.ci.tnt_interaction_$(target),limit=1,type=interaction] attack set from storage sgp.ci:tnt_clicks attack
$assert data entity @e[tag=sgp.ci.tnt_interaction_$(target),limit=1,type=interaction] attack{timestamp:1L}
