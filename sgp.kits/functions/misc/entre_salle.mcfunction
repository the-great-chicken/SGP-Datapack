...
execute if entity @s[scores={entre_kits=1..}] as @s run function sgp.misc:scoreboards/player_initialization
execute if entity @s[scores={spawn_vers_kits=1..}] as @s run function sgp.spawns:disable_triggers
