...
execute if entity @a[scores={sgp.death_effect=1..}] store result entity @e[tag=sgp.marker,name="death_reaper",limit=1] Pos[0] double 0.01 run scoreboard players get @a[scores={sgp.death_effect=1..},limit=1] sgp.posx1
execute if entity @a[scores={sgp.death_effect=1..}] store result entity @e[tag=sgp.marker,name="death_reaper",limit=1] Pos[1] double 0.01 run scoreboard players get @a[scores={sgp.death_effect=1..},limit=1] sgp.posy1
execute if entity @a[scores={sgp.death_effect=1..}] store result entity @e[tag=sgp.marker,name="death_reaper",limit=1] Pos[2] double 0.01 run scoreboard players get @a[scores={sgp.death_effect=1..},limit=1] sgp.posz1
...
kill @e[tag=sgp.marker,name="death_reaper",limit=1]