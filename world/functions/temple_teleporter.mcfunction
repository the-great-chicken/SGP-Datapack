...
scoreboard players add @a[tag=a_teleporter] teleporteur 1
execute as @a[tag=a_teleporter,scores={teleporteur=60}] run tp @s 2500.5 224.5 2147.5 0 0
execute as @a[tag=a_teleporter,scores={teleporteur=60}] at @s run particle minecraft:reverse_portal ~ ~1 ~ 0 0 0 1 200 normal
execute as @a[x=2485.5,y=210.5,z=2169.5,distance=1..,tag=a_teleporter] run stopsound @s ambient block.portal.trigger
execute as @a[x=2485.5,y=210.5,z=2169.5,distance=1..,tag=a_teleporter] run scoreboard players set @s teleporteur 0
