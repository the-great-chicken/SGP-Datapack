execute if score #scoreboard_and_clearlag test matches 0 run scoreboard objectives setdisplay sidebar plusgrandestreak
...
execute if score #scoreboard_and_clearlag test matches 1 run scoreboard objectives setdisplay sidebar le5
