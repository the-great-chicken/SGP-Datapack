...
execute positioned 0.0 88.0 0.0 run function sgp.ci:repulsion/scenarios/single_trigger/1
await entity @e[tag=sgp.ci.repulsion,tag=!sgp.ci.repulsion_peer,scores={sgp.trigger_repulsion=0},type=husk]
execute positioned 0.0 88.0 0.0 run function sgp.ci:repulsion/scenarios/single_trigger/2
