...
execute positioned 0.0 88.0 0.0 run function sgp.ci:repulsion/scenarios/facing/1
await entity @e[tag=sgp.ci.repulsion,tag=!sgp.ci.repulsion_peer,scores={sgp.trigger_repulsion=0},type=husk]
execute positioned 0.0 88.0 0.0 run function sgp.ci:repulsion/scenarios/facing/2
