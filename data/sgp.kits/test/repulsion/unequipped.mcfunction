...
execute positioned 0.0 88.0 0.0 run function sgp.ci:repulsion/scenarios/unequipped/1
await delay 3t
execute positioned 0.0 88.0 0.0 run function sgp.ci:repulsion/scenarios/unequipped/2
