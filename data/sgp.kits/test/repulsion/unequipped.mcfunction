...
execute positioned 0.0 128.0 0.0 run function sgp.ci:repulsion/phases/unequipped/arm_without_enchantment
await delay 3t
execute positioned 0.0 128.0 0.0 run function sgp.ci:repulsion/phases/unequipped/assert_ignored
