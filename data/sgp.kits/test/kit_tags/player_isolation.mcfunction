...
data modify storage sgp.ci:kit_tags player_isolation set value {}
...
execute store result storage sgp.ci:kit_tags player_isolation.before int 1 run clear KitSwitchOther minecraft:golden_apple 0
...
function sgp.kits:kit_tags/management
function sgp.kits:kills_give/check
execute store result storage sgp.ci:kit_tags player_isolation.apples int 1 run clear KitSwitchOther minecraft:golden_apple 0
execute store result storage sgp.ci:kit_tags player_isolation.arrows int 1 run clear KitSwitchOther minecraft:arrow 0
dummy KitSwitchOther leave

assert data storage sgp.ci:kit_tags player_isolation{before:0,apples:1,arrows:3}
assert entity @s[tag=sgp.peaceful]
assert not entity @s[nbt={Inventory:[{}]}]
data remove storage sgp.ci:kit_tags player_isolation
