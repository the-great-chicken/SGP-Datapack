...
execute store result storage sgp.ci:kills_give player_isolation.pyro_arrows int 1 run clear RewardPyro minecraft:arrow 0
execute store result storage sgp.ci:kills_give player_isolation.pyro_explosives int 1 run clear RewardPyro minecraft:strider_spawn_egg 0
execute store result storage sgp.ci:kills_give player_isolation.pyro_apples int 1 run clear RewardPyro minecraft:golden_apple 0
data modify storage sgp.ci:kills_give player_isolation.idle set from entity RewardIdle Inventory
data modify storage sgp.ci:kills_give player_isolation.no_kit set from entity RewardNoKit Inventory
