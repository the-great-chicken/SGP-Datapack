#> sgp.kits:kd_projectiles/calculated_buff_end
# @dummy
# @environment sgp.ci:kd_projectiles/calculated_buff_end
#
# The buff ends above K/D 0.80 for both melee and arrows.
...
function sgp.ci:kd_projectiles/scenarios/calculated_buff_end
