#> sgp.kits:kd_projectiles/minimum_kills
# @dummy
# @environment sgp.ci:kd_projectiles/minimum_kills
#
# The projectile debuff does not apply before ten kills.
...
function sgp.ci:kd_projectiles/fire {kd:400,kills:9,deaths:10}
