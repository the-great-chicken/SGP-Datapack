#> sgp.kits:kd_projectiles/minimum_deaths
# @dummy
# @environment sgp.ci:kd_projectiles/minimum_deaths
#
# The projectile buff does not apply before ten deaths.
...
function sgp.ci:kd_projectiles/fire {kd:30,kills:10,deaths:9}
