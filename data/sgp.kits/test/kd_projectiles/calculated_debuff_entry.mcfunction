#> sgp.kits:kd_projectiles/calculated_debuff_entry
# @dummy
# @environment sgp.ci:kd_projectiles/calculated_debuff_entry
#
# The debuff begins at K/D 2.00 for both melee and actual arrow damage.
