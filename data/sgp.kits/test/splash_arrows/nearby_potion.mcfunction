#> sgp.kits:splash_arrows/nearby_potion
...
assert entity @e[tag=sgp.ci.splash_potion,tag=!sgp.ci.splash_control,distance=..6,nbt={Item:{components:{"minecraft:potion_contents":{custom_effects:[{id:"minecraft:poison",amplifier:1b,duration:99}]}}}},type=splash_potion]
