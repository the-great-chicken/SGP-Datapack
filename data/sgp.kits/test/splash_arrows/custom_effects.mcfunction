#> sgp.kits:splash_arrows/custom_effects
...
assert entity @e[tag=sgp.ci.splash_potion,distance=..6,nbt={Item:{components:{"minecraft:potion_contents":{custom_effects:[{id:"minecraft:poison",amplifier:2b,duration:87},{id:"minecraft:slowness",amplifier:1b,duration:145}]}}}},type=splash_potion]
