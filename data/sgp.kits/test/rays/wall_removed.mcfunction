...
function sgp.ci:rays/update
function sgp.ci:rays/beam {direction:south,scale:"6990..7010",center:"1745..1755"}
execute positioned 8.5 88.6 8.5 run assert entity @e[tag=sgp.ray,tag=sgp.south,scores={sgp.dummy=3495..3505,sgp.timer=66},distance=..0.01,type=item_display]
setblock 8 88 12 air
function sgp.ci:rays/update
function sgp.ci:rays/beam {direction:south,scale:"31990..32010",center:"7995..8005"}
function sgp.ci:rays/update
function sgp.ci:rays/beam {direction:south,scale:"31990..32010",center:"7995..8005"}
execute positioned 8.5 88.6 8.5 run assert entity @e[tag=sgp.ray,tag=sgp.south,scores={sgp.dummy=16000,sgp.timer=62},distance=..0.01,type=item_display]
