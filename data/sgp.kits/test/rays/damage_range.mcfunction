#> sgp.kits:rays/damage_range
# @dummy
# @environment sgp.ci:rays/damage_range
#
# A beam hits a player within reach but does not damage a player beyond sixteen blocks.
...
await delay 61t
function sgp.ci:rays/scenarios/damage_range
