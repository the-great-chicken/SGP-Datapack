...
data modify storage sgp.ci:stats identity set value {player_id:910009,uuid:[I;1,2,3,4],nickname:"First"}
function sgp.kits:stats_collector/player_identity/save with storage sgp.ci:stats identity
...
data modify storage sgp.ci:stats identity set value {player_id:910009,uuid:[I;-1,-2,-3,-4],nickname:"Renamed"}
function sgp.kits:stats_collector/player_identity/save with storage sgp.ci:stats identity
