...
execute if entity @s[scores={sgp.kits_vers_spawn=1..}] unless score #confines_secondes sgp.timer matches 1.. run tp @s @e[type=marker,tag=sgp.marker,name="spawns",limit=1]
