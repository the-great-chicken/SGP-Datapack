...
execute if entity @s[scores={sgp.kits_vers_spawn=1..}] if score #confines_secondes sgp.timer matches 1.. run tp @s @e[tag=sgp.marker,name="Confinement",limit=1,sort=random] 
