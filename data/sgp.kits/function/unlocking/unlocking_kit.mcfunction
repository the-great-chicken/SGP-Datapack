...
$title @s title [{"storage":"sgp.text", "nbt":"prefix", "interpret":true}, {"text":"$(kit) Trouvé !", "color":"$(kit_color)", "bold":true}]
$tellraw @a [{"storage":"sgp.text", "nbt":"prefix", "interpret":true}, {"selector":"@s", "bold":true, "color":"white"}, {"text":" a trouvé le kit ", "color":"aqua"}, {"text":"$(kit)", "bold":true, "color":"$(kit_color)"}]
