...
$execute if score @s sgp.$(kit)_found matches 1 run return \
    run tellraw @s [{storage:"sgp.text", nbt:"prefix", interpret:true}, {text:"Tu as déjà trouvé ce kit...", color:red}]
...
$scoreboard players set @s sgp.$(kit)_found 1