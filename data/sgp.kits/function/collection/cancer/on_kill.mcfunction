...
execute as @a[tag=sgp.cancer,scores={sgp.kills_give_1=1..}] run function sgp.kits:kills_give/basic { \
    ...
    execute as @a[tag=sgp.alchimiste,scores={sgp.kills_give_1=1..}] run give @s golden_apple[ \
    ...
    give: 'splash_potion["minecraft:custom_name":\'{"bold":true,"color":"dark_red","italic":false,"text":"Potion de Rapidité"}\', \
        "minecraft:lore": [ \
