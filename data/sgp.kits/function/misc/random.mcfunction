...
execute if score #random_kit_roll sgp.dummy matches 1 as @s run scoreboard players enable @s sgp.veut_combattant
...
execute if score #random_kit_roll sgp.dummy matches 2 as @s run scoreboard players enable @s sgp.veut_roi
...
execute if score #random_kit_roll sgp.dummy matches 3 as @s run scoreboard players enable @s sgp.veut_pigeon
...
execute if score #random_kit_roll sgp.dummy matches 4 as @s run scoreboard players enable @s sgp.veut_archer
...
execute if score #random_kit_roll sgp.dummy matches 5 as @s run scoreboard players enable @s sgp.veut_tank
...
execute if score #random_kit_roll sgp.dummy matches 6 as @s run scoreboard players enable @s sgp.veut_vindicateur
...
execute if score #random_kit_roll sgp.dummy matches 7 as @s run scoreboard players enable @s sgp.veut_eclaireur
...
execute if score #random_kit_roll sgp.dummy matches 8 as @s run scoreboard players enable @s sgp.veut_poseidon
...
execute if score #random_kit_roll sgp.dummy matches 9 as @s run scoreboard players enable @s sgp.veut_alchimiste
...
execute if score #random_kit_roll sgp.dummy matches 10 as @s run scoreboard players enable @s sgp.veut_enderman
...
execute if score #random_kit_roll sgp.dummy matches 11 as @s run scoreboard players enable @s sgp.veut_cancer
...
execute if score #random_kit_roll sgp.dummy matches 12 as @s run scoreboard players enable @s sgp.veut_pyromane
