...
execute if entity @s[scores={sgp.sort_kits=1..}] run tp @s @n[type=marker,tag=sgp.marker,name="accueil"]
...
execute if entity @s[scores={sgp.kits_vers_spawn=1..}] unless score #confines_secondes sgp.timer matches 1.. run function sgp.spawns:enable_triggers
execute if entity @s[scores={sgp.kits_vers_spawn=1..}] unless score #confines_secondes sgp.timer matches 1.. run tp @s @n[type=marker,tag=sgp.marker,name="spawns"]
