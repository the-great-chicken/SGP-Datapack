...
execute positioned ~ ~1 ~ as @e[limit=5] run summon bat ~ ~ ~ {Tags:["sgp.bat_grenade"]}
execute positioned ~ ~ ~ as @e[type=bat,tag=sgp.bat_grenade,sort=nearest,limit=5] run function #bs.health:time_to_live {with:{time:10,unit:"s"}}
