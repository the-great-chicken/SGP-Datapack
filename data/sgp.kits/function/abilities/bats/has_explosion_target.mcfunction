...
execute if entity @a[tag=sgp.in_game,tag=!sgp.cancer,tag=!sgp.peaceful,limit=1,distance=..2.5] run return 1
execute if entity @e[tag=sgp.illusion,distance=..2.5,limit=1,type=mannequin] run return 1
