...
execute unless entity @s[tag=sgp.fire_explosion_bigger] at @s as @a[tag=sgp.in_game,tag=!sgp.peaceful,distance=..4] run damage @s 2 on_fire
...
execute if entity @s[tag=sgp.fire_explosion_bigger] at @s as @a[tag=sgp.in_game,tag=!sgp.peaceful,distance=..8] run damage @s 2 on_fire