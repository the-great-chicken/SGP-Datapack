...
execute if entity @s[tag=sgp.combattant] run return run function sgp.kits:abilities/cleave/start
...
execute if entity @s[tag=sgp.vindicateur] run return run function sgp.kits:abilities/fangs/start
