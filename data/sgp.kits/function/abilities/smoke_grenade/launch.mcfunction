...
execute anchored eyes positioned ^ ^ ^1 run summon snowball ~ ~ ~ {Tags:["sgp.smoke_grenade", "sgp.just_fired"], Passengers:[{id:"minecraft:item_display", Tags:["sgp.smoke_visual"], item:{id:"minecraft:snowball", count:1}, item_display:"fixed", transformation:{scale:[3.0f, 3.0f, 3.0f],right_rotation:{axis:[0,0,0],angle:0},left_rotation:{axis:[0,0,0],angle:0},translation:[0,-0.5f,-1f]}}]}
