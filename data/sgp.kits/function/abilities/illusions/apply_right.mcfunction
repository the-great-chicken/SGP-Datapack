...
scoreboard players operation $px bs.in = @e[type=marker,tag=sgp.illusion_center,distance=..0.01,limit=1] bs.pos.x
scoreboard players operation $py bs.in = @e[type=marker,tag=sgp.illusion_center,distance=..0.01,limit=1] bs.pos.y
scoreboard players operation $pz bs.in = @e[type=marker,tag=sgp.illusion_center,distance=..0.01,limit=1] bs.pos.z
