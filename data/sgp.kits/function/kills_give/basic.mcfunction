...
# `{give: minecraft_item, give_2: minecraft_item, actionbar: json_text_component, nb: [1,2,3], threshold: int, width: int}`
# 
...
$scoreboard players remove @s sgp.kills_give_$(nb) $(threshold)
