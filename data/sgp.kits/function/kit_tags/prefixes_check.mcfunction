...
execute unless entity @a[tag=sgp.adding_prefix] if entity @a[scores={sgp.kit_prefix_set=0},tag=sgp.peaceful] run function sgp.kits:kit_tags/prefixes_update {kit:peaceful}
