...
execute as @a[tag=sgp.particle.cloud,tag=sgp.intensity.light,predicate=sgp.misc:is_sneaking] at @s run particle minecraft:cloud ~ ~2.0 ~ 0.18 0 0.18 0 2
execute as @a[tag=sgp.particle.cloud,tag=sgp.intensity.medium,predicate=sgp.misc:is_sneaking] at @s run particle minecraft:cloud ~ ~2.0 ~ 0.21 0 0.21 0 5
execute as @a[tag=sgp.particle.cloud,tag=sgp.intensity.heavy,predicate=sgp.misc:is_sneaking] at @s run particle minecraft:cloud ~ ~2.0 ~ 0.25 0 0.25 0 10
