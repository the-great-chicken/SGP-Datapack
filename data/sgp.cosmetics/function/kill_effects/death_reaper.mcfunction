...
execute if entity @p[scores={sgp.death_effect=1..}] as @n[type=marker,tag=sgp.marker,name="death_reaper"] run function sgp.cosmetics:kill_effects/update_death_reaper_coords
...
kill @n[type=marker,tag=sgp.marker,name="death_reaper"]