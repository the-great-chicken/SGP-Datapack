...
execute if entity @s[tag=anvil_kill] run function sgp.cosmetics:kill_effects/anvil
...
execute if entity @s[tag=firework_kill] run function sgp.cosmetics:kill_effects/firework
