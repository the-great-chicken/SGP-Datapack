...
#message de mort
tellraw @a[tag=sgp.in_game] [{storage:"sgp.text", nbt:"prefix", interpret:true},{selector: "@s"},{text: " de l'équipe "},{score: {name: "#death_teams",objective: "sgp.link_teams"}},{text: " a été éliminé(e) !"}]
