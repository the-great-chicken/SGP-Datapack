...
title @s title [{text: "Tu pourras chasser dans "},{score:{name:"@s",objective:"sgp.timer"}}]

execute unless score @s sgp.timer matches ..0 run function #bs.schedule:schedule {run:"function sgp.majeurs:hide_and_seek/timer/become_seeker",with:{id:"hide_and_seek",time:1,unit:"s"}}
