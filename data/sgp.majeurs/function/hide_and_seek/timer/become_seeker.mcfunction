...
execute unless score @s sgp.timer matches ..0 run function #bs.schedule:schedule {run:"function sgp.majeurs:hide_and_seek/timer/become_seeker",with:{time:1,unit:"s"}}
