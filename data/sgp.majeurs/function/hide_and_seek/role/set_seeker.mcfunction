...
item replace entity @s armor.legs with minecraft:leather_leggings[dyed_color={rgb:11546150,show_in_tooltip:true},hide_tooltip={},enchantments={levels:{binding_curse:1},show_in_tooltip:false},enchantment_glint_override=false]
