...
#
# Handles actions when a team ("Poule," "Canard," or "Oie") is uncaged. 
...
$execute as @e[type=marker,tag=sgp.marker,name="pco_uncage_storage",nbt={data:{cage:$(cage)}}] run function sgp.majeurs:pco/cage/compute_markers_coordinates
$execute as @e[type=marker,tag=sgp.marker,name="pco_uncage_storage",nbt={data:{cage:$(cage)}}] run function sgp.majeurs:pco/cage/clone_cage with entity @s data
