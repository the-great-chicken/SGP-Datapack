...
item replace entity @s hotbar.0 with feather[ \
    custom_name='{"text":"Plume", "color":"green", "italic":false, "bold":true}', \
    lore=[ \
...
item replace entity @s armor.head with leather_helmet[ \
    custom_name='{"text":"Tête", "color":"green", "italic":false, "bold":true}', \
    enchantments={ \
...
item replace entity @s armor.chest with leather_chestplate[ \
    custom_name='{"text":"Corps", "color":"green", "italic":false, "bold":true}', \
    enchantments={ \
        levels: {binding_curse:1}, \
        show_in_tooltip:false \
        }, \
...
item replace entity @s armor.legs with leather_leggings[ \
    custom_name='{"text":"Cuisses", "color":"green", "italic":false, "bold":true}', \
    enchantments={ \
        levels: {binding_curse:1}, \
        show_in_tooltip:false \
        }, \
...
item replace entity @s armor.feet with leather_boots[ \
    custom_name='{"text":"Pattes", "color":"green", "italic":false, "bold":true}', \
    enchantments={ \
        levels: {binding_curse:1}, \
        show_in_tooltip:false \
        }, \
...
item replace entity @s weapon.offhand with bread[ \
    custom_name='{"text":"Miettes", "color":"green", "italic":false, "bold":true}', \
    lore=[ \
        '[ \
