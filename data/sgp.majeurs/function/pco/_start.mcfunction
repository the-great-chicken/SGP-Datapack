...
tellraw @a[team=sgp.Poule] [{text:"Tu es une ",color:white},{text:"Poule. ",color:red,bold:true},{text:"Vous devez chasser les ",color:white},{text:"Canards.",color:green,bold:true}]
