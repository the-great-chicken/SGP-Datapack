...
execute as @e[type=marker,tag=sgp.marker,name="devenir_chasseur",limit=1] at @s run data modify block ^ ^1 ^1 {} merge value {front_text:{messages:['[""]','["",{text:"DEVENIR",bold:true,color:green}]','[{text:"CHASSEUR",bold:true,color:green,click_event:{action:run_command,command:"trigger sgp.devenir_chasseur"}}]','[""]']}}
execute as @e[type=marker,tag=sgp.marker,name="devenir_pigeon",limit=1] at @s run data modify block ^ ^1 ^1 {} merge value {front_text:{messages:['[""]','["",{text:"DEVENIR",bold:true,color:dark_gray}]','[{text:"PIGEON",bold:true,color:dark_gray,click_event:{action:run_command,command:"trigger sgp.devenir_pigeon"}}]','[""]']}}
