...
execute if score $time.hours bs.out matches 21 if score $time.minutes bs.out matches 58 run function sgp.majeurs:scheduler/ptk
...
schedule function sgp.majeurs:scheduler/main 30s