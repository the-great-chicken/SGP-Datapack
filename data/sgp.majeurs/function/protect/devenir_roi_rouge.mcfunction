...
execute at @n[type=marker,tag=sgp.marker,name="devenir_roi_rouge"] as @a[distance=..2] run team join sgp.rouge @s
...
tp @p[scores={sgp.devenir_roi_rouge=1..}] @n[type=marker,tag=sgp.marker,name="protect_spawn_rouges"]
execute at @n[type=marker,tag=sgp.marker,name="devenir_roi_rouge"] as @a[distance=..2] run scoreboard players set @s sgp.entre_kits 1
