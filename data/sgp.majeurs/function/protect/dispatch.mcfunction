...
tp @a[tag=sgp.major_participant,tag=sgp.select] @e[type=marker,tag=sgp.marker,name="devenir_roi_bleu",limit=1]
tp @a[tag=sgp.major_participant,tag=!sgp.select] @e[type=marker,tag=sgp.marker,name="devenir_roi_rouge",limit=1]
