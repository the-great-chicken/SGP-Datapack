execute as @a[tag=in_game] run scoreboard players operation @s sgp.temps_cabane_pco_secondes = @s sgp.temps_cabane_pco
execute as @a[tag=in_game] run scoreboard players operation @s sgp.temps_cabane_pco_secondes /= 100 sgp.dummy
execute as @a[tag=in_game] run function sgp.majeurs:pco/dans_cabane_actionbar
