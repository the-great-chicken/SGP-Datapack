...
execute unless entity @a[team=sgp.bleue] unless predicate sgp.majeurs:roi_bleu_vivant run tellraw @a[tag=in_game] [{"text":"L'Equipe ", "color":"gold", "bold":true}, {"text":"Rouge ", "color":"dark_red"}, "a gagné ! ", {"text":"Tous les Bleus sont vivants. ","bold":false}]
...
execute unless entity @a[team=sgp.rouge] unless predicate sgp.majeurs:roi_rouge_vivant run tellraw @a[tag=in_game] [{"text":"L'Equipe ", "color":"gold", "bold":true}, {"text":"Bleu ", "color":"dark_blue"}, "a gagné ! ", {"text":"Tous les Rouges sont vivants. ","bold":false}]
