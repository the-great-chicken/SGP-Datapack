execute as @p[scores={sgp.devenir_roi_bleu=1..}] run function sgp.kits:collection/roi
...
tag @p[scores={sgp.devenir_roi_bleu=1..}] add roi_bleu
execute at @e[tag=sgp.marker,name="sgp.devenir_roi_bleu",limit=1] as @a[distance=..2] run team join sgp.bleue @s
...
execute at @e[tag=sgp.marker,name="sgp.devenir_roi_bleu",limit=1] as @a[distance=..2] run scoreboard players set @s sgp.entre_kits 1
