...
execute at @e[tag=sgp.marker,name="devenir_roi_rouge",limit=1] as @a[distance=..2] run team join sgp.rouge @s
...
execute at @e[tag=sgp.marker,name="devenir_roi_rouge",limit=1] as @a[distance=..2] run scoreboard players set @s sgp.entre_kits 1
