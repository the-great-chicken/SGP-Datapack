...
execute at @e[tag=sgp.marker,name="devenir_roi_rouge",limit=1] as @a[distance=..2] run scoreboard players enable @s sgp.devenir_roi_rouge
execute at @e[tag=sgp.marker,name="devenir_roi_rouge",limit=1] as @a[distance=..2] run title @s title [{"text":"Équipe Rouge", "color":"dark_red"}]
execute at @e[tag=sgp.marker,name="devenir_roi_bleu",limit=1] as @a[distance=..2] run scoreboard players enable @s sgp.devenir_roi_bleu
execute at @e[tag=sgp.marker,name="devenir_roi_bleu",limit=1] as @a[distance=..2] run title @s title [{"text":"Équipe Bleue", "color":"dark_blue"}]
setblock 2480 230 2166 minecraft:prismarine_brick_slab[type=bottom]
statuswarp pvp disabled
execute at @e[tag=sgp.marker,name="devenir_roi_bleu",limit=1] as @a[distance=..2] run move @s #Bleus
execute at @e[tag=sgp.marker,name="devenir_roi_rouge",limit=1] as @a[distance=..2] run move @s #Rouges
useglow toggle
