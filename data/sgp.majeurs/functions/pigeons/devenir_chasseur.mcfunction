...
execute at @e[type=marker,tag=sgp.marker,name="sgp.devenir_chasseur",limit=1] as @a[distance=..2] unless entity @s[tag=tag1] run tp @s @e[type=marker,tag=sgp.marker,name="sgp.devenir_pigeon",limit=1]
