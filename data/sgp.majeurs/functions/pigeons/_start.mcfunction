...
execute as @e[tag=sgp.marker,name="devenir_chasseur",limit=1] at @s run setblock ^ ^1 ^1 oak_wall_sign[facing=north]{front_text:{messages:['[""]','["",{"text":"DEVENIR","bold":true,"color":"green"}]','[{"text":"CHASSEUR","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"trigger sgp.devenir_chasseur"}}]','[""]']}}
execute as @e[tag=sgp.marker,name="devenir_pigeon",limit=1] at @s run setblock ^ ^1 ^1 oak_wall_sign[facing=north]{front_text:{messages:['[""]','["",{"text":"DEVENIR","bold":true,"color":"dark_gray"}]','[{"text":"PIGEON","bold":true,"color":"dark_gray","clickEvent":{"action":"run_command","value":"trigger sgp.devenir_pigeon"}}]','[""]']}}
