...
$execute as @e[predicate=bs.link:link_equal,tag=sgp.giant_mannequin_$(id),type=mannequin] run function sgp.diorama:tick/update_mannequin/apply_mannequin_pos
