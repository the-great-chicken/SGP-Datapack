#> sgp.diorama:tick/update_mannequin/update_giant_pos
# `{id: int}`
...
$execute as @e[predicate=bs.link:link_equal,tag=sgp.giant_mannequin_$(id),limit=1,type=mannequin] run function sgp.diorama:tick/update_mannequin/apply_mannequin_pos
...
$item replace entity @e[predicate=bs.link:link_equal,tag=sgp.giant_mannequin_$(id),limit=1,type=mannequin] weapon.mainhand from entity @s weapon.mainhand
$item replace entity @e[predicate=bs.link:link_equal,tag=sgp.giant_mannequin_$(id),limit=1,type=mannequin] weapon.offhand from entity @s weapon.offhand