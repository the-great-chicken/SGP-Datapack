#> sgp.diorama:lifecycle/leave_and_reenter
# @dummy
# @environment sgp.ci:diorama_lifecycle/leave_and_reenter
...
function sgp.ci:diorama_lifecycle/scenarios/leave_and_reenter
