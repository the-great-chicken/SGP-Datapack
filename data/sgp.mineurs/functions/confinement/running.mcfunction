...
execute if score #confines_secondes sgp.timer matches 19 if score #confines_ticks sgp.timer matches 0 if score #confines_minutes sgp.timer matches 0 run stopsound @a[tag=in_game] ambient minecraft:music_disc.strad

# Faits des dégâts quand les joueurs ne sont pas en Intérieur
execute if score #confines_secondes sgp.timer matches 19.. if score #confines_ticks sgp.timer matches 0 in minisjeux_crea as @a[tag=in_game] at @s unless block ~ ~1 ~ #sgp.mineurs:confinement_invincible unless block ~ ~ ~ #sgp.mineurs:confinement_invincible unless block ~1 ~1 ~ #sgp.mineurs:confinement_invincible unless block ~ ~1 ~1 #sgp.mineurs:confinement_invincible unless block ~ ~1 ~-1 #sgp.mineurs:confinement_invincible unless block ~-1 ~1 ~ #sgp.mineurs:confinement_invincible unless block ~ ~2 ~ #sgp.mineurs:confinement_invincible run title @s title "Rentrez en Intérieur !"
execute if score #confines_secondes sgp.timer matches 19.. if score #confines_ticks sgp.timer matches 0 in minisjeux_crea as @a[tag=in_game] at @s unless block ~ ~1 ~ #sgp.mineurs:confinement_invincible unless block ~ ~ ~ #sgp.mineurs:confinement_invincible unless block ~1 ~1 ~ #sgp.mineurs:confinement_invincible unless block ~ ~1 ~1 #sgp.mineurs:confinement_invincible unless block ~ ~1 ~-1 #sgp.mineurs:confinement_invincible unless block ~-1 ~1 ~ #sgp.mineurs:confinement_invincible unless block ~ ~2 ~ #sgp.mineurs:confinement_invincible run damage @s 4 starve
