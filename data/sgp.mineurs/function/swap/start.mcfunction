tellraw @a[tag=sgp.in_game] ["",{"text":"SWAP! ", "color":"dark_green", "bold":true},{"text":"Le Canarchimage a remplacé le kit de tout le monde par un kit Aléatoire !", "color":"green"}]
