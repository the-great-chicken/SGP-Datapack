...
tellraw @a[tag=sgp.in_game] [{"storage":"sgp.text", "nbt":"prefix", "interpret":true}, {"translate":"sgp.mineurs:lootdrop_chest_found", "fallback":"Le coffre a été trouvé !", "color":"gold"}]
