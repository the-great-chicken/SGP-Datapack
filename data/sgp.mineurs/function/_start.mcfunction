tellraw @a[tag=sgp.in_game] [{"storage":"sgp.text", "nbt":"prefix", "interpret":true}, {"translate":"sgp.mineurs:activation_minor_events", "fallback":"Activation des Événements Mineurs", "color":"green", "bold":true}]
