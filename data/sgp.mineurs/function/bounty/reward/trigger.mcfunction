#trigger the reward
execute if score @s sgp.reward matches 1 run function sgp.mineurs:bounty/reward/macros {reward:"strenght",function:"effect give @s strength 120 0 true"}
...
execute if score @s sgp.reward matches 4 run function sgp.mineurs:bounty/reward/macros {reward:"health_boost",function:"loot give @s loot sgp.mineurs:reward_bounty_items"}
