...
execute if score #confines_secondes sgp.timer matches 19 if score #confines_ticks sgp.timer matches 0 run tellraw @a[tag=sgp.in_game] [{"storage":"sgp.text", "nbt":"prefix", "interpret":true}, {"translate":"sgp.mineurs:confinement_prefix", "fallback":"CONFINEMENT ! ", "bold":true}, {"translate":"sgp.mineurs:confinement_start", "fallback":"L'événement a commencé et se terminera dans 2 minutes 30s !", "color":"white"}]
...
# Fin de l'event
execute if score #confines_secondes sgp.timer matches 150.. run tellraw @a[tag=sgp.in_game] [{"storage":"sgp.text", "nbt":"prefix", "interpret":true}, {"translate":"sgp.mineurs:confinement_prefix", "fallback":"CONFINEMENT ! ", "color":"gray", "bold":true}, {"translate":"sgp.mineurs:confinement_stop", "fallback":"L'événement est terminé ! Vous pouvez ressortir en toute securité !", "color":"white"}]
