...
execute if score #reflexes_ticks sgp.timer matches 100.. run return run function sgp.mineurs:reflexes/end

schedule function sgp.mineurs:reflexes/running 1t