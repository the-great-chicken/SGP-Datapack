...
data modify storage sgp.ci:bounty reward_choices set value {}
attribute @s minecraft:max_health base set 20
function sgp.mineurs:bounty/reward/message
trigger sgp.reward set 4
function sgp.mineurs:bounty/reward/trigger
execute store success storage sgp.ci:bounty reward_choices.reuse byte 1 run trigger sgp.reward set 4
function sgp.mineurs:bounty/reward/message
trigger sgp.reward set 4
function sgp.mineurs:bounty/reward/trigger
execute store success storage sgp.ci:bounty reward_choices.retry_duplicate byte 1 run trigger sgp.reward set 3
function sgp.mineurs:bounty/reward/trigger
execute store result storage sgp.ci:bounty reward_choices.max_health int 1 run attribute @s minecraft:max_health get

function sgp.mineurs:bounty/reward/message
trigger sgp.reward set 99
function sgp.mineurs:bounty/reward/trigger
execute store success storage sgp.ci:bounty reward_choices.retry_invalid byte 1 run trigger sgp.reward set 1
function sgp.mineurs:bounty/reward/trigger
