#> sgp.integration.tab:luckperms/read_location
# `{uuid: string}`
...
execute if data storage sgp:macro tab.location_setup_marker.lieu run function sgp.integration.tab:luckperms/setup_location with storage sgp:macro tab.location_setup_marker
