...
execute as @s[tag=sgp.starts_climbing] run attribute @s minecraft:gravity modifier add climbing_boost -1 add_multiplied_total
...
execute as @s[tag=sgp.climbing] at @s unless predicate sgp.world:is_climbing run attribute @s minecraft:gravity modifier remove climbing_boost
