scoreboard players set @s sgp.ab.location_inside 1
...
$execute if score @s sgp.lieu_$(lieu) matches 1 run function sgp.world:lieu/second_time {lieu_propre:"$(lieu_propre)", couleur:"$(couleur)", width:$(width)}
