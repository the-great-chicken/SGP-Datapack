...
execute as @a[scores={sgp.death_reset_tags=1..}] run function sgp.misc:on_death
...
execute as @p[scores={sgp.spawn_random=1..}] run function sgp.spawns:random
execute as @a[scores={sgp.kits_vers_spawn=1..}] unless predicate sgp.majeurs:event_in_progress run function sgp.kits:misc/sort_salle
execute as @a[scores={sgp.kits_vers_spawn=1..}] if predicate sgp.majeurs:event_in_progress run function sgp.majeurs:common/kits_to_spawn
execute as @a[scores={sgp.spawn_vers_kits=1..}] run function sgp.kits:misc/entre_salle
...
execute at @e[type=marker,tag=sgp.marker,name="accueil",limit=1] as @a[distance=..1.5] unless score @s sgp.entre_kits > 0 sgp.dummy run scoreboard players enable @s sgp.entre_kits
execute at @e[type=marker,tag=sgp.marker,name="accueil",limit=1] as @a[distance=0] run function sgp.kits:misc/sort_salle
...
execute as @a[scores={sgp.veut_desactiver=1..}] run function sgp.cosmetics:particles/disable
...
execute at @e[type=marker,tag=sgp.marker,name="accueil",limit=1] as @a[distance=..1.5] unless score @s sgp.entre_cosm > 0 sgp.dummy run scoreboard players enable @s sgp.entre_cosm


# ------ Events Majeurs ------
# Protéger le Roi
execute if entity @a[scores={sgp.devenir_roi_bleu=1..}] run function sgp.majeurs:protect/devenir_roi_bleu
execute if entity @a[scores={sgp.devenir_roi_rouge=1..}] run function sgp.majeurs:protect/devenir_roi_rouge
...
# Chasse aux pigeons
execute as @a[scores={sgp.devenir_chasseur=1..}] run function sgp.majeurs:pigeons/devenir_chasseur
execute as @a[scores={sgp.devenir_pigeon=1..}] run function sgp.majeurs:pigeons/devenir_pigeon
