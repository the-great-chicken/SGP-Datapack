...
execute unless entity @a[predicate=sgp.majeurs:event_in_progress] if score @s sgp.kd matches ..50 if score @s sgp.morts matches 10.. run effect give @s minecraft:strength 7 0 true
execute if score @s sgp.kd matches 300.. if score @s sgp.kills matches 10.. run effect give @s minecraft:weakness 7 0 true
execute if score @s sgp.kd matches ..50 if score @s sgp.morts matches 10.. run effect give @s minecraft:regeneration 7 0 true