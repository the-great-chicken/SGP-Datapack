...
data modify storage sgp:data misc.actionbar.hud.ability_bar_widths set value [{width:10},{width:12},{width:14},{width:16},{width:16},{width:16},{width:16},{width:16},{width:16},{width:16},{width:16},{width:16},{width:16},{width:16},{width:16},{width:16},{width:16},{width:16},{width:16},{width:16},{width:16}]
