...
scoreboard players set #sgp.ab.hud_x sgp.dummy 6
...
scoreboard players set #sgp.ab.two sgp.dummy 2

scoreboard players set #sgp.ab.width.separator sgp.dummy 12
scoreboard players set #sgp.ab.width.water_trident sgp.dummy 64
scoreboard players set #sgp.ab.width.hide_hider sgp.dummy 125
scoreboard players set #sgp.ab.width.pco_cabane sgp.dummy 155
