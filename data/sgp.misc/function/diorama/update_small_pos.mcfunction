...
item replace entity @e[predicate=bs.link:link_equal,tag=sgp.small_mannequin,type=mannequin] weapon.mainhand from entity @s weapon.mainhand
item replace entity @e[predicate=bs.link:link_equal,tag=sgp.small_mannequin,type=mannequin] weapon.offhand from entity @s weapon.offhand