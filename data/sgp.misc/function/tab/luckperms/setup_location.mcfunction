#> sgp.misc:tab/luckperms/setup_location
...
execute if data storage sgp:macro tab.location_setup{first_color_character:"#"} run function sgp.misc:tab/luckperms/set_location_suffix_hex with storage sgp:macro tab.location_setup
execute unless data storage sgp:macro tab.location_setup{first_color_character:"#"} run function sgp.misc:tab/luckperms/set_location_suffix_named with storage sgp:macro tab.location_setup
