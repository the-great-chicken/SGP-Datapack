...
execute if score #tab_queue_turn sgp.dummy matches 0 if entity @a[scores={sgp.tab_dirty=0}] run return run function sgp.misc:tab/location/update
execute if score #tab_queue_turn sgp.dummy matches 1 if entity @a[scores={sgp.kit_prefix_set=0}] run return run function sgp.misc:tab/prefix/check

execute if entity @a[scores={sgp.tab_dirty=0}] run return run function sgp.misc:tab/location/update
execute if entity @a[scores={sgp.kit_prefix_set=0}] run return run function sgp.misc:tab/prefix/check
