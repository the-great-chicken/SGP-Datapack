#> sgp.misc:tab/location/clear

execute if score @a[tag=sgp.tab_target,limit=1] sgp.tab_applied matches 0 run return run function sgp.misc:tab/location/no_change
