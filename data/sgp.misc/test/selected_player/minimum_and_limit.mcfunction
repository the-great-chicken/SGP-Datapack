...
data modify storage sgp.ci:selected_player minimum_and_limit set value {}
...
execute store result storage sgp.ci:selected_player minimum_and_limit.seven int 1 if entity @a[tag=sgp.test.selection_seven]
tag SelBountyF remove sgp.in_game
function sgp.misc:selected_player/main {div:7,add:1,sign:"/",tag:"sgp.test.selection_six"}
execute store result storage sgp.ci:selected_player minimum_and_limit.six int 1 if entity @a[tag=sgp.test.selection_six]
...
execute store result storage sgp.ci:selected_player minimum_and_limit.seeker int 1 if entity @a[tag=sgp.test.selection_seeker]
function sgp.misc:selected_player/main {div:1,add:1,sign:"/",tag:"sgp.test.selection_oversized"}
execute store result storage sgp.ci:selected_player minimum_and_limit.oversized int 1 if entity @a[tag=sgp.test.selection_oversized]
...
assert data storage sgp.ci:selected_player minimum_and_limit{seven:2,six:1,seeker:1,oversized:1}
data remove storage sgp.ci:selected_player minimum_and_limit
