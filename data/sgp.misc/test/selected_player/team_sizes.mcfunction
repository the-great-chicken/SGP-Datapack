...
data modify storage sgp.ci:selected_player team_sizes set value {}
...
execute store result storage sgp.ci:selected_player team_sizes.five int 1 if entity @a[tag=sgp.test.selection_five]
tag SelTeamD remove sgp.in_game
function sgp.misc:selected_player/main {div:2,add:0,sign:"/",tag:"sgp.test.selection_four"}
execute store result storage sgp.ci:selected_player team_sizes.four int 1 if entity @a[tag=sgp.test.selection_four]
execute store result storage sgp.ci:selected_player team_sizes.outside int 1 if entity @a[tag=!sgp.in_game,tag=sgp.test.selection_four]
...
execute store result storage sgp.ci:selected_player team_sizes.one int 1 if entity @a[tag=sgp.test.selection_one]
dummy SelTeamA leave
dummy SelTeamB leave
dummy SelTeamC leave
dummy SelTeamD leave

assert data storage sgp.ci:selected_player team_sizes{five:2,four:2,outside:0,one:0}
data remove storage sgp.ci:selected_player team_sizes
