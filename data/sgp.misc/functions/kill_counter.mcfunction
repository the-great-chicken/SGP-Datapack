...
execute as @a if score @s last_kill_count matches 1.. run execute store result score #kit_id_tueur sgp.dummy run scoreboard players get @s sgp.kit_id
execute as @a if score @s last_kill_count matches 1.. run scoreboard players set @s last_kill_count 0
