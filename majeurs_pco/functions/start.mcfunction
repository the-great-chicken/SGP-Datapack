...
function majeurs_pco:clone_cage_canards
function majeurs_pco:clone_cage_poules
function majeurs_pco:clone_cage_oies
...
execute as @a[team=Oie] run function majeurs_pco:oie
execute as @a[team=Poule] run function majeurs_pco:poule
execute as @a[team=Canard] run function majeurs_pco:canard
