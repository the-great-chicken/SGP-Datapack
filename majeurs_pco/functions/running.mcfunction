...
execute if score #poules en_cage = #poules_joueurs dummy run function majeurs_pco:stop
...
execute if score #canards en_cage = #canards_joueurs dummy run function majeurs_pco:stop
...
execute if score #oies en_cage = #oies_joueurs dummy run function majeurs_pco:stop
