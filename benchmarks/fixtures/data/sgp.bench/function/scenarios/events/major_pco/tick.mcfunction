...
execute unless score #pco_restart sgp.bench matches 1.. run return 0
scoreboard players add #pco_restart_phase sgp.bench 1
execute if score #pco_restart_phase sgp.bench < #pco_restart sgp.bench run return 0
scoreboard players set #pco_restart_phase sgp.bench 0
function sgp.bench:scenarios/events/major_pco/restart with storage sgp.bench:events pco
