...
execute unless score @s sgp.lieu_gallerie >= 0 sgp.dummy run scoreboard players set @s sgp.lieu_galerie 0
...
execute unless score @s sgp.lieu_repos >= 0 sgp.dummy run scoreboard players set @s sgp.lieu_repos 0
