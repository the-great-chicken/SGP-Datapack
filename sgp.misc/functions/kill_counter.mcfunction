execute if data storage minecraft:kill_counter HandItems[0].tag.KillUpdates[0] store result score #counter_increment_array sgp.dummy run data get storage minecraft:kill_counter HandItems[0].tag.KillUpdates[0]
execute if score #counter_increment_array sgp.dummy matches 0 run data modify storage minecraft:kill_counter HandItems[0].tag.increment set from storage minecraft:kill_counter HandItems[0].tag.KillArray[0]
execute if score #counter_increment_array sgp.dummy matches 0 store result score #increment sgp.dummy run data get storage minecraft:kill_counter HandItems[0].tag.increment
...
execute if score #counter_increment_array sgp.dummy matches 0 store result storage minecraft:kill_counter HandItems[0].tag.increment int 1 run scoreboard players get #increment sgp.dummy
execute if score #counter_increment_array sgp.dummy matches 0 run data modify storage minecraft:kill_counter HandItems[0].tag.KillArray[0] set from storage minecraft:kill_counter HandItems[0].tag.increment
...
execute if data storage minecraft:kill_counter HandItems[0].tag.KillUpdates[0] run scoreboard players operation #counter_increment_array sgp.dummy -= 1 sgp.dummy
execute if data storage minecraft:kill_counter HandItems[0].tag.KillUpdates[0] store result storage minecraft:kill_counter HandItems[0].tag.KillUpdates[0] int 1 run scoreboard players get #counter_increment_array sgp.dummy
...
execute if score #kit_id_kill_run sgp.dummy matches 1 store result storage minecraft:kill_counter HandItems[0].tag.provKillTueur int 1 run scoreboard players get #kit_id_tueur sgp.dummy
execute if score #kit_id_kill_run sgp.dummy matches 1 store result storage minecraft:kill_counter HandItems[0].tag.provKillVictime int 1 run scoreboard players get #kit_id_victime sgp.dummy
...
execute if score #kit_id_kill_run sgp.dummy matches 1 store result storage minecraft:kill_counter HandItems[0].tag.provKillUpdate int 1 run scoreboard players get #kit_id_tueur sgp.dummy
execute if score #kit_id_kill_run sgp.dummy matches 1 run data modify storage minecraft:kill_counter HandItems[0].tag.KillUpdates append from storage minecraft:kill_counter HandItems[0].tag.provKillUpdate
