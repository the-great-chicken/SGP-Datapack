...
execute if score #confines_secondes timer >= 19 dummy if score #confines_ticks timer matches 0 in minisjeux_crea as @a[x=2405,y=201,z=2133,dx=137,dy=49,dz=72] at @s unless block ~ ~1 ~ #sgp.mineurs:confinement_invincible unless block ~ ~ ~ #sgp.mineurs:confinement_invincible unless block ~1 ~1 ~ #sgp.mineurs:confinement_invincible unless block ~ ~1 ~1 #sgp.mineurs:confinement_invincible unless block ~ ~1 ~-1 #sgp.mineurs:confinement_invincible unless block ~-1 ~1 ~ #sgp.mineurs:confinement_invincible unless block ~ ~2 ~ #sgp.mineurs:confinement_invincible run title @s title "Rentrez en Intérieur !"
execute if score #confines_secondes timer >= 19 dummy if score #confines_ticks timer matches 0 in minisjeux_crea as @a[x=2405,y=201,z=2133,dx=137,dy=49,dz=72] at @s unless block ~ ~1 ~ #sgp.mineurs:confinement_invincible unless block ~ ~ ~ #sgp.mineurs:confinement_invincible unless block ~1 ~1 ~ #sgp.mineurs:confinement_invincible unless block ~ ~1 ~1 #sgp.mineurs:confinement_invincible unless block ~ ~1 ~-1 #sgp.mineurs:confinement_invincible unless block ~-1 ~1 ~ #sgp.mineurs:confinement_invincible unless block ~ ~2 ~ #sgp.mineurs:confinement_invincible run damage @s 4 starve
...
# Récursivité
execute unless score #confines_minutes timer matches 3 run schedule function sgp.mineurs:confinement/running 1
